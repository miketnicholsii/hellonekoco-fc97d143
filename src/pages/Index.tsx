          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10 mb-16">
              ...
              >
                ...
                <div className="space-y-3 text-white/70 text-sm inline-flex flex-col items-start mx-auto">
                  <p className="flex items-center gap-2">
                    <Check className="w-3.5 h-3.5 text-[#E5530A]/70 flex-shrink-0" />
              ...
              >
                ...
                <div className="space-y-3 text-white/40 text-sm inline-flex flex-col items-start mx-auto">
                  <p className="flex items-center gap-2">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-6 text-lg sm:text-xl leading-relaxed" style={{ color: "#334336" }}>
              ...
              <motion.p
                ...
                transition={{ delay: 0.4 }}
              >
                Bring your heart and your hustle, <span className="blur-[4px] hover:blur-none transition-all duration-300 select-none cursor-pointer text-[#E5530A]">punk</span>.
              </motion.p>
              <motion.p 
