      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-gradient-hero overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10 text-center pt-20">
          <div className="max-w-3xl mx-auto">
            <span className="inline-block text-xs font-semibold tracking-wide uppercase text-primary-foreground/60 mb-6">
              About NÈKO
            </span>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold tracking-tightest text-primary-foreground mb-6 animate-slide-up">
              Hello.
            </h1>
            <p className="text-lg md:text-xl text-primary-foreground/70 mb-4 animate-slide-up stagger-1">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {values.map((value, index) => (
              <div
                key={value.title}
                className={`p-8 rounded-2xl bg-card border border-border hover:border-primary/30 hover:shadow-md transition-all duration-300 animate-slide-up stagger-${(index % 2) + 1}`}
              >
