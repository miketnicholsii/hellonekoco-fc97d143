...
export const nekoCopy = {
  brand: {
    ...
    subdescriptor:
      "This is where we build real websites, real strategies, and real digital systems — sometimes collaboratively, sometimes quietly. Sometimes we share what we're learning. Sometimes we don't.",
  ...
  mission: {
    ...
    body: [
      ...
      "Money coming in helps us help others. This isn't charity framing — it's transparent impact.",
  ...
  sections: {
    ...
    legitimacy: {
      ...
      body: [
        "We do professional-level work. We accept payment when it aligns.",
  ...
  sandbox: {
    title: "The Sandbox",
    body: [
      "NÈKO is a working landscape — a place where we explore ideas through building.",
  ...
  invite: {
    ...
    rateSignal: {
      ...
      hourlyRate: "$375",
      rateUnit: "/ hour",
      description: "If we work together, time is typically priced as a baseline — not as a menu.",
      context: [
        "For small builds, we usually propose a capped range after a short call.",
      ],
      note1: "We accept payment when the work aligns with NÈKO.",
      note2: "If it doesn't align, we'll say so — and we'll still try to be helpful.",
    },
    engagement: {
      ...
      options: [
        {
          ...
          description: "Tell us what you're building and what you can invest. If it aligns, we'll find a shape.",
  ...
  contact: {
    ...
    body: [
      ...
      "If it's aligned and the timing works, we'll respond.",
    ...
    form: {
      ...
      fields: {
        ...
        building: { label: "What are you building?", placeholder: "Tell us about your project or idea..." },
      ...
      submit: "Send",
      success: "Message sent. We'll be in touch if we're aligned.",
    },
  },
  ...
  notes: {
    ...
    coming: "Coming soon.",
    body: "Occasional updates, experiments, and things we've learned.",
  },
  ...
  // The compass line
  compass:
    "NÈKO is a legitimate creative sandbox — where real work happens, but nothing is promised on demand.",
};
